...
public class MemberFrame extends Frame
{
	...
	public MemberFrame(MainFrame frm)
	{
		this.frm=frm;
		...
		String lblCaptions[]=new String[4];
		lblCaptions[0]="Name : ";
		lblCaptions[1]="Access : ";
		lblCaptions[2]="Type : ";
		lblCaptions[3]="Members : ";
		...
		if(frm.btnName.equals("dataMemberAdd"))
		{
			for(int index=0;index<4;index++)
			{
