...
@MessageDriven(name="MailMDB",
	activationConfig=
	{
		...
		@ActivationConfigProperty(propertyName="destinationType",propertyValue="javx.jms.Queue"),
...
public class MailSender implements MessageListener
{
	...
	public void onMessage(Message arg0)
	{
		if(arg0 instanceof ObjectMessage)
		{
			...
			Session session=Session.getInstance(props,new AuthenticatorImpl());
			
			
				MimeMessage email=new MimeMessage(session);
				email.setSubject(data.getSubject());
				email.setContent(data.getMsg(),"text/html");
				email.addFrom(new InternetAddress[]{new InternetAddress("iacsd101@gmail.com")});
				...
				System.out.println("msg del at "+new Date());
			}
